...
class CategoryTranslationController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('CategoryTranslation');
	...
	{
		$model=new CategoryTranslation('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['CategoryTranslation']))
			$model->attributes=$_GET['CategoryTranslation'];
	 ...
	 * @param CategoryTranslation $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='category-translation-form')
		{
