...
class ArticlesTranslationController extends Controller
{
	/**
	...
	public function actionCreate($id)
	{
		...
		{
			$model->attributes=$_POST['ArticlesTranslation'];
	...
	{
		$dataProvider=new CActiveDataProvider('ArticlesTranslation');
	...
	{
		$model=new ArticlesTranslation('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ArticlesTranslation']))
			$model->attributes=$_GET['ArticlesTranslation'];
	 ...
	 * @return ArticlesTranslation the loaded model
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='articles-translation-form')
		{
